...
<body>
    <h1>INVOICE</h1>
    <header>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents('assets/invoices/22.png')) }}" width="100%"
            height="100%" />
    </header>
    ...
    <br>
    <table border="0" cellspacing="0" style="width: 100%; ">
        <tr style="background-color:#001f4b;text-align:center;color:white;">
            <td>
                号
            </td>
            <td>
    ...
    <table border="0" cellspacing="0" style="width: 100%; ">
        ...
        <tr>
            ...
            <td style="background-color:#001f4b;color:white">
                請求⾦額 
            </td>
            <td style="text-align: right;background-color:#001f4b;color:white">
    ...
    <footer>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents('assets/invoices/2.png')) }}" width="100%"
            height="100%" />
    </footer>
</body>
