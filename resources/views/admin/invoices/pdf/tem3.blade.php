...
<body>
    <h1>INVOICE</h1>
    <header>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents('assets/invoices/33.png')) }}" width="100%"
            height="100%" />
    </header>
    ...
    <table border="1" cellspacing="0" style="width: 100%; ">
        <tr style="background-color:#faf609;text-align:center;color:black;">
            <td>
                号
            </td>
            <td>
            ...
            @endphp
        <tr style="text-align: center;border-bottom: 1px solid #001f4b;">
            <td>
                {{ $loop->iteration }}
            </td>
            <td>
    ...
    <table border="0" cellspacing="0" style="width: 100%; ">
        ...
        <tr>
            ...
            <td style="background-color:#faf609;color:black">
                請求⾦額 
            </td>
            <td style="text-align: right;background-color:#faf609;color:black">
    ...
    <footer>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents('assets/invoices/3.png')) }}" width="100%"
            height="100%" />
    </footer>
</body>
