...
<body>
    <div style="color: white;line-height:0.5rem">
        <h1>INVOICE</h1>
        <b>NOTE: {{$da->note}}</b>
    </div>
    <header>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents('assets/invoices/4.png')) }}" width="100%"
            height="100%" />
    </header>
    <br><br>
    ...
    <table border="1" cellspacing="0" style="width: 100%; ">
        <tr style="background-color:#921919;text-align:center;color:white;">
            <td>
                号
            </td>
            <td>
    ...
    <table border="0" cellspacing="0" style="width: 100%; ">
        ...
        <tr>
            ...
            <td style="background-color:#921919;color:white">
                請求⾦額 
            </td>
            <td style="text-align: right;background-color:#921919;color:white">
